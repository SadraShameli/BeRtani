        ...
        <div className='flex md:divide-x'>
            <div className='hidden gap-10 pr-16 md:grid'>
                ...
                <div className='pt-10'>
                    ...
                    <div className='grid gap-5 fill-current'>
                        <button className='flex gap-x-4 text-sm' type='button'>
                ...
                <div className='border-t pt-10'>
                    ...
                    <div className='grid gap-5 fill-current'>
                        ...
                        <button className='flex gap-x-4 text-sm' type='button' onClick={() => signOut({ callbackUrl: '/' })}>
                            <SignOutIcon className='h-5 w-5 stroke-current' />
                            Sign out
                        </button>
                    </div>
                </div>
            ...
            <div className='flex flex-1 flex-col md:px-16'>
                ...
                <div className='mt-20 grid place-items-center gap-5'>
                    ...
                    <Link className='btn-primary btn mt-2' href='/'>
                        Continue shopping
                    </Link>
                </div>
            </div>
